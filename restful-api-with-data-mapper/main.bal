...
service /university on new http:Listener(port) {
    ...
    resource function post persons/[int id]/enroll(Course[] courses)
        ...
        log:printInfo("Enrolling student with id: ", id= id);
        if persons.hasKey(id) {
            log:printInfo("Enrolling key found with id: ", id= id);
            Person person = persons.get(id);
            Student student = enrollPerson(person, courses);
            log:printInfo("Enrolling student enrollment SUCCESS: ", id= student);
            do {
                ...
                return student;
                 ...
                 log:printInfo("Enrolling student enrollment ERROR: ", err= err.message());
